...
### [x] NW-V2-S4-003 P0 路由兼容层收口与旧入口退役
...
- 已删除 legacy 路由别名、旧入口引用和未挂载的 legacy feature 包。
- 路由文档已收口为 canonical-only 事实源。
- 相关前端 typecheck 与全量测试已通过。
