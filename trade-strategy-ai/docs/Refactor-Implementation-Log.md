...
- 下一步：等待用户明确授权后续 Stage 11 task，按冻结顺序优先建议 `RT-S11-006 灰度迁移和回滚`；不得自动启动 scheduler、automation、alerting、recovery runtime、cost-control runtime、route retirement 或 Stage 12。
...
| Stage 11 | `[-]` | Bootstrap `READY`；RT-S11-001 / 002 / 003 / 004 / 005 / 007 已接受，`RT-S11-006` 未开始 | [stage-11.md](refactor-implementation-logs/stage-11.md) |
...
```text
RT-S11-006 灰度迁移和回滚：
RT-S11-001 / RT-S11-002 / RT-S11-003 / RT-S11-004 / RT-S11-005 / RT-S11-007 已接受，后续任务仅在用户明确授权后开始；不得自动启动 scheduler、automation、alerting、recovery runtime、cost-control runtime、route retirement 或 Stage 12
```
...
不得自动开始 `RT-S11-006` 及后续 Stage 11 task；必须等待用户明确授权后才能推进下一步。
