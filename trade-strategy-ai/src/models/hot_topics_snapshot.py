...
class HotTopicsSnapshot(TimestampMixin, Base):
    """热点主题每日快照。"""

    __tablename__ = "hot_topics_snapshots"
    __table_args__ = (
        UniqueConstraint("trade_date", "slot", "source", "dataset_version", name="uq_hot_topics_snapshots_identity"),
        Index("ix_hot_topics_snapshots_trade_date_slot", "trade_date", "slot"),
    )
