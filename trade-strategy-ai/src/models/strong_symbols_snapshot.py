...
class StrongSymbolsSnapshot(TimestampMixin, Base):
    """强势标的快照。"""

    __tablename__ = "strong_symbols_snapshots"
    __table_args__ = (
        UniqueConstraint("trade_date", "slot", "source", "dataset_version", name="uq_strong_symbols_snapshots_identity"),
        Index("ix_strong_symbols_snapshots_trade_date_slot", "trade_date", "slot"),
    )
