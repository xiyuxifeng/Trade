...
STRATEGY_PIPELINE_SPEC = PipelineSpec(
    ...
    input_schema={
        ...
        "fields": {
            ...
            "snapshot_id": {
                "type": "string",
                "description": "当前 Market Snapshot ID",
                "required": False,
                "default": None,
                "enum": [],
            },
            "market_regime_version": {
                ...
                "description": "市场状态版本",
                "required": False,
                "default": "market-regime-v3",
                "enum": [],
            },
            "source_feature_version": {
                "type": "string",
                "description": "Market Regime 特征版本",
                "required": False,
                "default": "market-regime-features-v3",
                "enum": [],
            },
            "applicability_profile_version": {
                "type": "string",
                "description": "规则适用性画像版本",
                "required": False,
                "default": "rule-applicability-v1",
                "enum": [],
            },
            "selected_by": {
                "type": "string",
    ...
    output_artifacts=(
        ...
        PipelineOutputArtifactSpec(
            kind="regime-selection-json",
            title="Regime 规则选择 JSON",
            description="Regime-aware rule selection 的可审计结果摘要，供策略工作台和盘前流程消费。",
            previewable=True,
            extensions={"required": False, "runtime_support": "current"},
        ),
    ),
    ...
    steps=(
        PipelineStepSpec(
            ...
            output_artifacts=("result-json", "regime-selection-json"),
