...
class AkshareProvider(ProviderBase):
    ...
    def __init__(self, *, tool: Any | None = None, provider_name: str = "akshare") -> None:
    ...
    def fetch_ohlcv_1d(
        ...
        *,
        ...
        return self._dispatch_daily_request(req=req, market_kind=market_kind)
