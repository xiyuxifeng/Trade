...
def test_ui_openapi_exposes_critical_contract_paths() -> None:
    ...
    expected_methods = {
        ...
        "/api/ui/v1/strategies": {"get", "post"},
        "/api/ui/v1/strategies/draft-options": {"get"},
        "/api/ui/v1/strategies/{version_id}": {"get"},
        "/api/ui/v1/strategies/{version_id}/submit-review": {"post"},
        "/api/ui/v1/strategies/{version_id}/publish": {"post"},
        "/api/ui/v1/strategies/{version_id}/validate": {"post"},
        "/api/ui/v1/strategies/{version_id}/comparison": {"get"},
        "/api/ui/v1/strategies/{version_id}/diff": {"get"},
        "/api/ui/v1/strategies/{version_id}/rollback": {"post"},
        "/api/ui/v1/strategies/proposals": {"get", "post"},
        "/api/ui/v1/strategies/proposals/{proposal_id}": {"get"},
        "/api/ui/v1/strategies/proposals/{proposal_id}/review": {"post"},
        "/api/ui/v1/strategies/proposals/{proposal_id}/accept-to-draft": {"post"},
        ...
        "/api/ui/v1/rules/backtests/runs/{run_id}/applicability-profiles": {"post"},
        "/api/ui/v1/rules/backtests/applicability-profiles/{profile_id}/review": {"post"},
        "/api/ui/v1/rules/backtests/applicability-profiles/{profile_id}/publish": {"post"},
    ...
    expected_request_refs = {
        ...
        ("/api/ui/v1/strategies", "post"): "#/components/schemas/StrategyDraftRequest",
        ("/api/ui/v1/strategies/{version_id}/submit-review", "post"): "#/components/schemas/StrategyTransitionRequest",
        ("/api/ui/v1/strategies/{version_id}/publish", "post"): "#/components/schemas/StrategyTransitionRequest",
        ("/api/ui/v1/strategies/{version_id}/validate", "post"): "#/components/schemas/StrategyValidationRequest",
        ("/api/ui/v1/strategies/{version_id}/rollback", "post"): "#/components/schemas/StrategyRollbackRequest",
        ("/api/ui/v1/strategies/proposals", "post"): "#/components/schemas/StrategyProposalCreateRequest",
        ("/api/ui/v1/strategies/proposals/{proposal_id}/review", "post"): "#/components/schemas/StrategyProposalReviewRequest",
        ("/api/ui/v1/strategies/proposals/{proposal_id}/accept-to-draft", "post"): "#/components/schemas/StrategyProposalAcceptRequest",
        ...
        ("/api/ui/v1/rules/backtests/runs/{run_id}/applicability-profiles", "post"): "#/components/schemas/FormalApplicabilityDraftRequest",
        ("/api/ui/v1/rules/backtests/applicability-profiles/{profile_id}/review", "post"): "#/components/schemas/FormalApplicabilityReviewRequest",
        ("/api/ui/v1/rules/backtests/applicability-profiles/{profile_id}/publish", "post"): "#/components/schemas/FormalApplicabilityPublishRequest",
