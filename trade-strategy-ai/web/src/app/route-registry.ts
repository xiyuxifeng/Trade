...
export const routeRegistry: RouteRecord[] = [
  ...
  { label: '管理中心', path: '/admin/audit', description: '用户、运维与权限管理入口', kind: 'canonical' },
  ...
  { label: '数据健康', path: '/data-health', description: '健康检查与报告产物', kind: 'legacy', retirementStage: 'V3' },
  ...
  { label: '运维', path: '/ops', description: '管理员运维与恢复入口', kind: 'legacy', retirementStage: 'V3' },
