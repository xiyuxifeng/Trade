...
export const routeRegistry: RouteRecord[] = [
  ...
  { label: '告警', path: '/alerts', description: '告警历史、确认和测试入口', kind: 'canonical' },
  ...
  { label: '文章', path: '/articles', description: '文章工作台入口', kind: 'canonical' },
  { label: '文章', path: '/articles/run', description: '文章抓取与处理页面', kind: 'canonical' },
  { label: '文章', path: '/articles/list', description: '文章列表页面', kind: 'canonical' },
  { label: '文章', path: '/articles/quality', description: '文章数据质量页面', kind: 'canonical' },
  { label: '文章', path: '/articles/jobs', description: '文章最近任务页面', kind: 'canonical' },
  { label: '文章', path: '/articles/results', description: '文章处理结果页面', kind: 'canonical' },
  { label: '文章', path: '/articles/maintenance', description: '文章高级维护页面', kind: 'canonical' },
  { label: '市场数据', path: '/market', description: '市场数据总览与入口', kind: 'canonical' },
  { label: '市场快照', path: '/market/snapshots', description: '市场快照浏览器', kind: 'canonical' },
  ...
  { label: '策略', path: '/strategies/pre-market', description: '盘前准备入口', kind: 'canonical' },
  { label: '策略', path: '/strategies/after-close', description: '盘后复盘入口', kind: 'canonical' },
  ...
  { label: '规则池', path: '/rule-pool/:ruleId', description: '规则池详情与审核', kind: 'canonical' },
  { label: '产物', path: '/artifacts', description: '日志、下载文件与输出结果', kind: 'canonical' },
  { label: '产物', path: '/artifacts/:artifactId', description: '产物详情与预览下载', kind: 'canonical' },
