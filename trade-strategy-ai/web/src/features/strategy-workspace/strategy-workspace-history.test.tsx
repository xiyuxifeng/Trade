...
const strategyJobs: JobRecord[] = [
  {
    ...
    status: 'success',
    params: { config_path: 'config/strategy-v3.yaml', as_of_date: '2026-05-16' },
    result: null,
    error: null,
    artifacts: [],
    created_by: 'web',
  ...
  },
  {
    ...
    status: 'failed',
    params: { config_path: 'config/strategy-v3.yaml', trader_id: 'trader_a', strategy_date: '2026-05-16' },
    result: null,
